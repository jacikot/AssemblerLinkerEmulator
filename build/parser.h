...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    struct basic_symbol : Base
    {
...
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::vector<tokens::Initializer>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::vector<tokens::Initializer>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
      ...
      {}
#else
      basic_symbol (typename Base::kind_type t, const tokens::Directive*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, tokens::Expression*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const tokens::Expression*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, tokens::Instruction*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const tokens::Instruction*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, tokens::Line&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const tokens::Line& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, tokens::Operand&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const tokens::Operand& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yytype)
    {
      ...
      case 41: // directive
        value.template destroy< tokens::Directive* > ();
        break;

      case 40: // expression
        value.template destroy< tokens::Expression* > ();
        break;

      case 45: // instruction
        value.template destroy< tokens::Instruction* > ();
        break;

      case 38: // line
        value.template destroy< tokens::Line > ();
        break;

      case 46: // operand_jmp
      case 47: // operand
        value.template destroy< tokens::Operand > ();
        break;
    ...
    struct symbol_type : basic_symbol<by_type>
    {
      ...
      {
        YY_ASSERT (tok == token::TOK_NUMBER || tok == token::TOK_HEX);
      }
#else
      ...
      symbol_type (int tok, std::string v, location_type l)
        : super_type(token_type (tok), std::move (v), std::move (l))
      {
        YY_ASSERT (tok == token::TOK_REG || tok == token::TOK_SYMBOL || tok == token::TOK_MNM0 || tok == token::TOK_MNM1OP || tok == token::TOK_MNM1REG || tok == token::TOK_MNM2REGOP || tok == token::TOK_MNM2REGREG || tok == token::TOK_COMMENT);
      }
#else
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      static
      symbol_type
      make_REG_PC (location_type l)
      {
        return symbol_type (token::TOK_REG_PC, std::move (l));
      }
#else
      static
      symbol_type
      make_REG_PC (const location_type& l)
      {
        return symbol_type (token::TOK_REG_PC, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_REG_SP (location_type l)
      {
        return symbol_type (token::TOK_REG_SP, std::move (l));
      }
#else
      static
      symbol_type
      make_REG_SP (const location_type& l)
      {
        return symbol_type (token::TOK_REG_SP, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_REG_PSW (location_type l)
      {
        return symbol_type (token::TOK_REG_PSW, std::move (l));
      }
#else
      static
      symbol_type
      make_REG_PSW (const location_type& l)
      {
        return symbol_type (token::TOK_REG_PSW, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_REG (std::string v, location_type l)
      {
        return symbol_type (token::TOK_REG, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_REG (const std::string& v, const location_type& l)
      {
        return symbol_type (token::TOK_REG, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_HEX (int v, location_type l)
      {
      ...
      static
      symbol_type
      make_HEX (const int& v, const location_type& l)
      {
      ...
      static
      symbol_type
      make_MNM0 (std::string v, location_type l)
      {
        return symbol_type (token::TOK_MNM0, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_MNM0 (const std::string& v, const location_type& l)
      {
        return symbol_type (token::TOK_MNM0, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_MNM1OP (std::string v, location_type l)
      {
        return symbol_type (token::TOK_MNM1OP, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_MNM1OP (const std::string& v, const location_type& l)
      {
        return symbol_type (token::TOK_MNM1OP, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_MNM1REG (std::string v, location_type l)
      {
        return symbol_type (token::TOK_MNM1REG, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_MNM1REG (const std::string& v, const location_type& l)
      {
        return symbol_type (token::TOK_MNM1REG, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_MNM2REGOP (std::string v, location_type l)
      {
        return symbol_type (token::TOK_MNM2REGOP, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_MNM2REGOP (const std::string& v, const location_type& l)
      {
        return symbol_type (token::TOK_MNM2REGOP, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_MNM2REGREG (std::string v, location_type l)
      {
        return symbol_type (token::TOK_MNM2REGREG, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_MNM2REGREG (const std::string& v, const location_type& l)
      {
        return symbol_type (token::TOK_MNM2REGREG, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
    ...
    , location (std::move (that.location))
  {
    switch (this->type_get ())
    {
      ...
      case 41: // directive
        value.move< tokens::Directive* > (std::move (that.value));
        break;

      case 40: // expression
        value.move< tokens::Expression* > (std::move (that.value));
        break;

      case 45: // instruction
        value.move< tokens::Instruction* > (std::move (that.value));
        break;

      case 38: // line
        value.move< tokens::Line > (std::move (that.value));
        break;

      case 46: // operand_jmp
      case 47: // operand
        value.move< tokens::Operand > (std::move (that.value));
        break;
    ...
    , location (that.location)
  {
    switch (this->type_get ())
    {
      ...
      case 41: // directive
        value.copy< tokens::Directive* > (YY_MOVE (that.value));
        break;

      case 40: // expression
        value.copy< tokens::Expression* > (YY_MOVE (that.value));
        break;

      case 45: // instruction
        value.copy< tokens::Instruction* > (YY_MOVE (that.value));
        break;

      case 38: // line
        value.copy< tokens::Line > (YY_MOVE (that.value));
        break;

      case 46: // operand_jmp
      case 47: // operand
        value.copy< tokens::Operand > (YY_MOVE (that.value));
        break;
  ...
  parser::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    switch (this->type_get ())
    {
      ...
      case 41: // directive
        value.move< tokens::Directive* > (YY_MOVE (s.value));
        break;

      case 40: // expression
        value.move< tokens::Expression* > (YY_MOVE (s.value));
        break;

      case 45: // instruction
        value.move< tokens::Instruction* > (YY_MOVE (s.value));
        break;

      case 38: // line
        value.move< tokens::Line > (YY_MOVE (s.value));
        break;

      case 46: // operand_jmp
      case 47: // operand
        value.move< tokens::Operand > (YY_MOVE (s.value));
        break;
